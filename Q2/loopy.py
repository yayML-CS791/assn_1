...
class Inference:
    def __init__(self, data: dict):
        ...
        rows = [self.state_factor_potentials[i * K : (i + 1) * K] for i in range(total_num_assignments)]
        ...
        for i_ob in range(self.num_observations):
            ...
            factor_potential = [rows[idx][obs_val] for idx in range(total_num_assignments)]
    ...
    def updateTransitionNodeBeliefs(self):
        ...
        for i_ob in range(self.num_observations - 1):
            for i_fact in range(self.factors_count):
                ...
                self.transition_beliefs[i_ob][i_fact] = normalise(self.transition_beliefs[i_ob][i_fact], self.states_count)
